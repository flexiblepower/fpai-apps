...
public class LedstripLevel {
    ...
    public void setLevel(int intLevel) {
        /*
         * int generatorLevel; if (intLevel == 0) { generatorLevel = 0; } else { generatorLevel = (intLevel / 100) *
         * 100;
         * 
         * if (generatorLevel > -1000) { generatorLevel = -1000; } else if (generatorLevel < -2000) { generatorLevel =
         * -2000; }
         * 
         * }
         * 
         ...
         */
        level = Measure.valueOf(intLevel, SI.WATT);
    }
