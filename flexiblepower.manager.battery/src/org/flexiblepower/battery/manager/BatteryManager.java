...
//
// // Based on the fill level functions and the transitions, create the three running modes
// RunningMode<FillLevelFunction<RunningModeBehaviour>> chargeRunningMode = new
// RunningMode<FillLevelFunction<RunningModeBehaviour>>(BatteryMode.CHARGE.ordinal(),
// "charging",
// chargeFillLevelFunctions,
// chargeTransition);
// RunningMode<FillLevelFunction<RunningModeBehaviour>> idleRunningMode = new
// RunningMode<FillLevelFunction<RunningModeBehaviour>>(BatteryMode.IDLE.ordinal(),
// "idle",
// idleFillLevelFunctions,
// idleTransition);
// RunningMode<FillLevelFunction<RunningModeBehaviour>> dischargeRunningMode = new
// RunningMode<FillLevelFunction<RunningModeBehaviour>>(BatteryMode.DISCHARGE.ordinal(),
// "discharging",
// dischargeFillLevelFunctions,
// dischargeTransition);
//
