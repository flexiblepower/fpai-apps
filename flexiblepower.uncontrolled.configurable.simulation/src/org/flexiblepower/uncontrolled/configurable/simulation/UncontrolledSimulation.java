package org.flexiblepower.uncontrolled.configurable.simulation;
...
import org.flexiblepower.uncontrolled.configurable.simulation.UncontrolledSimulation.Config;
...
public class UncontrolledSimulation extends AbstractResourceDriver<UncontrolledState, UncontrolledControlParameters> implements
    ...
    interface Config {
        ...
        @Meta.AD(deflt = "0", description = "Stand by")
        double powerWhenStandBy();

        @Meta.AD(deflt = "200", description = "Low consumption (tv)")
        int powerWhenCloudy();

        @Meta.AD(deflt = "1500", description = "High consumption (espresso machine)")
        int powerWhenSunny();
