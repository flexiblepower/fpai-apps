...
public class PowerwallBatteryWidget implements Widget {
    ...
    public PowerwallBatteryWidget(GenericAdvancedBatteryDeviceModel model) {
        deviceModel = model;
    }
    ...
    public String getTitle(Locale locale) {
        return "Powerwall Battery Simulation";
    }
}
