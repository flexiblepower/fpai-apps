...
// cloudy = config.powerWhenCloudy();
// sunny = config.powerWhenSunny();
// logger.info("Starting PVpanel simulation");
// scheduledFuture = schedulerService.scheduleAtFixedRate(this, 0, config.updateFrequency(), TimeUnit.SECONDS);
// widget = new PVWidget(this);
// widgetRegistration = bundleContext.registerService(Widget.class, widget, null);
// } catch (RuntimeException ex) {
...
// }
//
// PowerState state = getCurrentState();
// logger.info("Publishing new PVSimulation state {}", state.getCurrentUsage());
// publishState(state);
// }
//
// public Weather getWeather() {
...
// // In normal situation nothing to control, however, for the simulation we need to control the weather....
//
// }
//
// double roundTwoDecimals(double d) {
...
// }
//
// protected PowerState getCurrentState() {
