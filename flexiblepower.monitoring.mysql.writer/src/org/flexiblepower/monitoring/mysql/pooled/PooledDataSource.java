...
public class PooledDataSource implements DataSource, ConnectionEventListener {
    ...
    private final BlockingQueue<PooledConnection> available = new LinkedBlockingDeque<PooledConnection>(POOL_SIZE);
    ...
    public void activate(Map<String, Object> properties) {
        ...
        try {
            ...
            logger.warn("Couldn't initialize a first connection for the connection pool", e);
        }
    }
    ...
    public Connection getConnection() throws SQLException {
        ...
        PooledConnection con = available.poll();
        if (con != null) {
        ...
        while (true) {
            ...
            // otherwise create a new connection
                ...
                final PooledConnection newcon = getConnectionPool().getPooledConnection();
    ...
    public Connection getConnection(String username, String password) throws SQLException {
        return getConnectionPool().getPooledConnection(username, password).getConnection();
    }
    ...
    private ConnectionPoolDataSource getConnectionPool() throws SQLException {
        ...
        synchronized (dataSourceFactory) {
            ...
            props.put(DataSourceFactory.JDBC_URL, configuration.jdbcURL());
            props.put(DataSourceFactory.JDBC_USER, configuration.jdbcUser());
            props.put(DataSourceFactory.JDBC_PASSWORD, configuration.jdbcPassword());

            try {
                return connectionPoolDataSource = dataSourceFactory.createConnectionPoolDataSource(props);
            } catch (SQLException e) {
                logger.error("Couldn't retrieve ConnectionPoolDataSource from the data source factory service", e);
                throw e;
            }
        }
    }
