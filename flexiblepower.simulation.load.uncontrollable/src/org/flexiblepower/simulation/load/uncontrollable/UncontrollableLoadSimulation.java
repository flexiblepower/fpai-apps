...
import org.flexiblepower.simulation.load.uncontrollable.UncontrollableLoadSimulation.Config;
...
public class UncontrollableLoadSimulation extends AbstractResourceDriver<PowerState, ResourceControlParameters>
                                                                                                               implements
    ...
    private UncontrollableLoadWidget widget;
    ...
    public void activate(BundleContext bundleContext, Map<String, Object> properties) throws MqttException {
        ...
        try {
            ...
            widget = new UncontrollableLoadWidget(this);
