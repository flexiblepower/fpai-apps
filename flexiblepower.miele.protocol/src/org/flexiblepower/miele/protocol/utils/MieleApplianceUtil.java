package org.flexiblepower.miele.protocol.utils;
...
/**
 * Utility class for interpreting property and values of the xml messages from the Miele Gateway.
 * 
 * @author IBM, TNO
 * @version 0.7.0
 */
public class MieleApplianceUtil {
    ...
    /**
     * Returns the appliance class id (int value) corresponding to the class name (description). The language parameter
     * indicates the class name description language.
     * 
     * @param language
    ...
    /**
     * Returns the appliance class name (description) corresponding to the class id in the specified language.
     * 
     * @param language
     *            The language used for the class name.
     * @param classId
    ...
    /**
     * Returns the property code corresponding with the specified key. The language specifies the key language.
     * 
     * @param key
     *            The property key.
     * @param language
    ...
    /**
     * Returns the state code (int value) corresponding to the state description. The language of the description is
     * specified by a parameter. If no language is specified the default language is considered to be German.
     * 
     * @param language
    ...
    /**
     * Returns the state description (value) corresponding to the state.
     * 
     * @param state
     *            The appliance state.
     * @return The appliance state description
     */
