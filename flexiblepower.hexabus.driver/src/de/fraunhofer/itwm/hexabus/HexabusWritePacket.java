...
public class HexabusWritePacket extends HexabusPacket {
    ...
    public HexabusWritePacket(int eid, Hexabus.DataType dataType, byte[] payload) {
        packetType = Hexabus.PacketType.WRITE;
        if (eid > 255) {
    ...
    public HexabusWritePacket(int eid, boolean value) {
        packetType = Hexabus.PacketType.WRITE;
        if (eid > 255) {
            throw new IllegalArgumentException("EID too large");
        }
    ...
    public HexabusWritePacket(int eid, float value) {
        packetType = Hexabus.PacketType.WRITE;
        if (eid > 255) {
            throw new IllegalArgumentException("EID too large");
        }
    ...
    public HexabusWritePacket(int eid, short value) {
        packetType = Hexabus.PacketType.WRITE;
        if (eid > 255) {
            throw new IllegalArgumentException("EID too large");
        }
    ...
    public HexabusWritePacket(int eid, long value) {
        packetType = Hexabus.PacketType.WRITE;
        if (eid > 255) {
            throw new IllegalArgumentException("EID too large");
        }
    ...
    public HexabusWritePacket(int eid, Timestamp value) {
        packetType = Hexabus.PacketType.WRITE;
        if (eid > 255) {
            throw new IllegalArgumentException("EID too large");
        }
    ...
    public HexabusWritePacket(int eid, Calendar value) {
        packetType = Hexabus.PacketType.WRITE;
        if (eid > 255) {
            throw new IllegalArgumentException("EID too large");
        }
    ...
    public HexabusWritePacket(int eid, String value) {
        packetType = Hexabus.PacketType.WRITE;
        if (eid > 255) {
            throw new IllegalArgumentException("EID too large");
        }
